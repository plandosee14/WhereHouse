	...
	<div class="container" id="mainDiv">
		<div class="nav-tabs-custom">
			...
			<ul>
				...
				<li class="active read"><a href="/mypage/checkForm"> <i
						class="fa fa-pencil"></i> <span>회원정보 수정</span>
				</a></li>
				<li><a href="/mypage/checkDelForm"> <i class="fa fa-trash"></i>
						<span>회원탈퇴</span></a></li>
			</ul>
			</aside>
			<div align="left">
				...
				<center>
					...
					<div class="pass_div">
						...
						<input class="btnStyle btn_confirm" type="button" value="확 인" id="pass">
					</div>
				</center>
			</div>
		</div>
