...
<body>
										...
										$('#searchlist')
												.append(
														"<div onmouseover='roll("
																...
																+ ")' style='font-size: small;float:left;width:100%;margin-bottom:10px;padding-bottom:10px;border-bottom: 1px dashed gray;' id=list"
																+ result[idx].h_no
																+ " class= 'list'><div style='display:inline-block;float:left;width:40%;'><a href='/detail?h_no="
																+ result[idx].h_no.toString()
	...
	<div style="width: 48%; position: absolute; margin: 1%; height: 70%;">
		...
		<center><div id="weatherlist" style="text-align: center; width:80%;"></div></center>
		<br><hr><br>
		<div id="searchlist"
